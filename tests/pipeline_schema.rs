...
fn test_parse_pipeline() -> Result<()> {
    ...
    const EXPECTED_DESCRIPTION: &str = "using a private key for SSH authentication and default 22 port";
    ...
    assert_eq!(first_server.description.as_deref(), Some(EXPECTED_DESCRIPTION));
